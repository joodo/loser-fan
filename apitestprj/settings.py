...
FF_API_KEY = PASSWORD['FF_API_KEY']
FF_API_SECRET = PASSWORD['FF_API_SECRET']

PUBLISHER_OAUTH_TOKEN = PASSWORD['PUBLISHER_OAUTH_TOKEN']
PUBLISHER_OAUTH_SECRET = PASSWORD['PUBLISHER_OAUTH_SECRET']
